      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500">
            AI-monitored canopy health, chlorosis detection, and parcel stress analytics.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-1 border-b md:border-b-0 md:border-r border-slate-100 pb-4 md:pb-0 md:pr-6">
            <span className="text-[10px] uppercase font-bold text-forest-700 tracking-wider">
              Estate Overall Health
            </span>
            <div className="flex items-baseline gap-2 mt-1">
              <span className="text-4xl sm:text-5xl font-black text-slate-900">{avgHealth}%</span>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Across all {currentFarm.fields.length} parcels in {currentFarm.name}
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-emerald-50/70 border border-emerald-100 flex flex-col justify-between">
            ...
            <p className="text-3xl font-black text-emerald-950 mt-2">80.3%</p>
          ...
          <div className="p-4 rounded-2xl bg-amber-50/70 border border-amber-100 flex flex-col justify-between">
            ...
            <p className="text-3xl font-black text-amber-950 mt-2">13.7%</p>
            <p className="text-[10px] text-amber-700 mt-1">Yellowing / mild moisture stress</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-rose-50/70 border border-rose-100 flex flex-col justify-between">
            ...
            <p className="text-3xl font-black text-rose-950 mt-2">6.0%</p>
            <p className="text-[10px] text-rose-700 mt-1">Foliar necrosis spotted</p>
          </div>
        </div>
      </div>

      {/* Field-by-Field Breakdown (Master Prompt Section 12) */}
